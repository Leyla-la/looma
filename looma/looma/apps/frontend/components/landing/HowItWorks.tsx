...
const steps = [
  ...
  },
  {
    ...
    desc: "Get your artwork instantly",
    icon: <ArrowRight />,
  },
];
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-ghibli-dark font-inter">
            Create stunning art in just 3 steps
          </p>
        </motion.div>
          ...
          {steps.map((s, i) => (
            ...
            >
              <div className="relative inline-block mb-6">
                <div className="w-20 h-20 rounded-full bg-linear-to-br from-ghibli-mint to-ghibli-sky flex items-center justify-center text-3xl font-bold text-white shadow-lg">
                  {s.step}
                </div>
              ...
              <p className="text-ghibli-dark font-inter">{s.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
